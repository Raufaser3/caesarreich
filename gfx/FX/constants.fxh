...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.75f; // we need to see if we need to raise a bit
...
static const float GB_THRESHOLD = 0.15f; // interpolation time
...
static const float GB_OPACITY_NEAR = 0.975f; // Transparency when camera is near
...
static const float GB_STRENGTH_CH2 = 0.50; // Opacity of top layer 
